      ...
      if (!readOnly) {
        ...
        scope.openAddDialog = () => {
          ...
          if (!addDialog) {
            ...
            addDialog = (<any>$)('<div modal="showAddDialog.show" close="closeAddDialog()" options="addDialogOptions">\n' +
        ...
        scope.openEditDialog = () => {
          ...
          if (!editDialog) {
            ...
            editDialog = (<any>$)('<div modal="showEditDialog.show" close="closeEditDialog()" options="editDialogOptions">\n' +
                    '<div class="modal-header"><h4>' + title + '</h4></div>\n' +
